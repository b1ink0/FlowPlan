...
const DisplayTree = ({ node }) => {
  ...
  return (
    <div
      ref={rootRef}
      className="hide-scroll-bar relative h-full grow  flex justify-center items-center overflow-hidden cursor-grab"
    >
      <Background />
...
const ZoomHelper = ({
  ...
  const { treeConfig } = settings;
  const { currentFlowPlan, setCurrentTransformState, setHandleTransform } =
    useStateContext();
  ...
  // const handleTransform = (key) => {
  //   if (rest?.instance?.transformState) {
  //     if (key === "d") {
  //       setTransform(
  //         rest?.instance?.transformState.positionX - 100,
  //         rest?.instance?.transformState.positionY,
  ...
  //     if (key === "s") {
  //       setTransform(
  //         rest?.instance?.transformState.positionX,
  //         rest?.instance?.transformState.positionY - 100,
  //         rest?.instance?.transformState.scale
  //       );
  //     }
  //     if (key === "w") {
